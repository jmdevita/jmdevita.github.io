    ...
    return (
      ...
      <section id="projects" className="s-works target-section">
        <div className="row narrow section-intro has-bottom-sep">
            ...
            <h3>Portfolio</h3>
            <h1>See My Successes.</h1>
            <p className="lead">I'm all about workspace automation and efficiency. But most importantly, I love to translate end-user goals to technological realities. Below are some presentations, projects, and guides for users.</p>
            </div>
        </div>
